...
var I18N = {
  en: {
    ...
    min3chars: 'Minimum 3 characters', onlyLettersNums: 'Only letters, numbers, _ and -', saved: '✓ Saved',
    ...
    repostMaxReached: '✓ Max reached (30 reposts). All Ambassador ranks are ready to claim!',
    ...
    contactAuthorCost: 'Contact · −{cost} SPK',
    myIdea: 'My Idea',
    openChat: 'Open Chat',
    caTitle: 'Contact Author 💬',
    caNotice: 'Opening this contact will deduct <strong>{cost} SPK</strong> from your balance. Note that we cannot guarantee the author will invite you to their project.',
    caBalLabel: 'Your balance:',
    caConfirmBtn: 'Open Chat · −{cost} SPK',
    caCancel: 'Cancel',
    caSuccess: '✓ Contact unlocked! −{cost} SPK',
    caErrBalance: 'Not enough SPK. Top up your balance.',
    caErrGeneric: 'Failed to unlock contact. Please try again.',
    directChatCostNotice: 'Adding @{name} directly costs {cost} SPK. Confirm?',
    directChatConfirmBtn: 'Open for {cost} SPK →',
    teamMembersLabel: 'Add members from your contacts',
    teamMembersEmpty: 'No unlocked contacts yet. Open contacts via idea cards first.',
    ccTitleTeam: 'New Team Channel 🗂',
    ccLabelChannel: 'Channel Name',
    ccPlaceholderChannel: 'e.g. #defi-alpha',
    ccBtnConfirm: 'Create Channel →',
    ccErrName: 'Channel name must be at least 3 characters',
    ccErrNameChars: 'Only letters, numbers, dashes and underscores',
    ccErrExists: 'A channel with this name already exists',
    chatDmsEmpty: 'No direct messages yet. Open contacts via idea cards.',
    chatTeamsEmpty: 'No team channels yet. Tap «+» to create one.',
    chatEmptyTitle: 'SPARK Signal Network',
    chatEmptyText: 'Select a contact or channel to start messaging.',
    chatSysCreated: ' created the channel',
    chatSysAdded: ' and added ',
    chatNoMessages: 'No messages yet. Be the first to write!',
    chatSysInit: 'Signal channel opened.',
    caAuthorSub: 'Idea Author',
  ...
  ru: {
    ...
    min3chars: 'Минимум 3 символа', onlyLettersNums: 'Только буквы, цифры, _ и -', saved: '✓ Сохранено',
    ...
    repostMaxReached: '✓ Максимум достигнут (30 репостов). Все ранги Амбассадора готовы к получению!',
    ...
    contactAuthorCost: 'Связаться · −{cost} SPK',
    myIdea: 'Моя идея',
    openChat: 'Открыть чат',
    caTitle: 'Связаться с автором 💬',
    caNotice: 'При открытии контакта списывается <strong>{cost} SPK</strong>. Обратите внимание, что мы не ручаемся за то, что автор идеи примет вас в проект.',
    caBalLabel: 'Ваш баланс:',
    caConfirmBtn: 'Открыть чат · −{cost} SPK',
    caCancel: 'Отмена',
    caSuccess: '✓ Контакт открыт! −{cost} SPK',
    caErrBalance: 'Недостаточно SPK. Пополните баланс.',
    caErrGeneric: 'Не удалось открыть контакт. Попробуйте ещё раз.',
    directChatCostNotice: 'Добавление @{name} напрямую стоит {cost} SPK. Подтвердить?',
    directChatConfirmBtn: 'Открыть за {cost} SPK →',
    teamMembersLabel: 'Добавить участников из контактов',
    teamMembersEmpty: 'Нет открытых контактов. Откройте контакты через карточки идей.',
    ccTitleTeam: 'Новый командный канал 🗂',
    ccLabelChannel: 'Название канала',
    ccPlaceholderChannel: 'напр. #defi-alpha',
    ccBtnConfirm: 'Создать канал →',
    ccErrName: 'Название канала — минимум 3 символа',
    ccErrNameChars: 'Только буквы, цифры, дефис и подчёркивание',
    ccErrExists: 'Канал с таким именем уже существует',
    chatDmsEmpty: 'Прямых сообщений пока нет. Откройте контакты через карточки идей.',
    chatTeamsEmpty: 'Каналов команд пока нет. Нажмите «+» для создания.',
    chatEmptyTitle: 'Сигнальная сеть SPARK',
    chatEmptyText: 'Выберите контакт или канал для начала общения.',
    chatSysCreated: ' создал(а) канал',
    chatSysAdded: ' и добавил(а) ',
    chatNoMessages: 'Сообщений пока нет. Напишите первым!',
    chatSysInit: 'Сигнальный канал открыт.',
    caAuthorSub: 'Автор идеи',
