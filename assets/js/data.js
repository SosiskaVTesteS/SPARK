...
var I18N = {
  en: {
    ...
    achHowStep1: 'Copy your personal verification code — it proves the post was written by you:',
  ...
  ru: {
    ...
    achHowStep1: 'Скопируйте ваш личный код верификации — он подтверждает что пост написан именно вами:',
